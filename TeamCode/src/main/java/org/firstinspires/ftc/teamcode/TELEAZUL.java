...
@TeleOp(name = "TELEOP FINAL - CORTEX AZUL", group = "CORTEX")
public class TELEAZUL extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        ctvl.setDirection(DcMotorSimple.Direction.REVERSE);
        ctvl.setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER);

        ctvl2 = hardwareMap.get(DcMotorEx.class, "CTVL2");
        ctvl2.setDirection(DcMotorSimple.Direction.FORWARD);
